import numpy as np
from Testbedengineperformance import A_t_to_A_n, A_inlet,eta_comp,eta_turb,total_conditions,station_3,station_4,station_5,station_8
...
print("Pressure ratio testbed:",Pt_07_to_Pt_04)
...
for i in range(1,15):
    ...
    print("Total pressure and temperature station 4:", P_t3, T_t3)
    ...
    P_t7, T_t7 = P_t5, T_t5
    print("Total pressure and temperature station 7:", P_t7, T_t7)
    ...
    print("Compressor ratio:", total_comp)
    print("Gross thrust at altitude:", F_G_calc)
    print("The turbine to propulsive nozzle pressure ratio is:", P_t7/P_t4)

    if P_t7/P_t4>Pt_07_to_Pt_04:
        total_comp+=0.1
    else:
        total_comp+=-0.1
